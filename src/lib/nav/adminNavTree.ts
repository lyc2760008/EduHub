...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        titleKey: "adminAnnouncements.page.title",
        iconKey: "requests",
        match: "prefix",
        roles: ADMIN_ONLY,
      },
      {
        id: "homework",
        href: "/admin/homework",
        labelKey: "admin.nav.homework",
        titleKey: "staffHomework.queue.title",
        iconKey: "requests",
        match: "prefix",
        roles: ADMIN_ONLY,
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "reports-announcements",
        href: "/admin/announcements/engagement",
      ...
      {
        id: "reports-homework-sla",
        href: "/admin/reports/homework-sla",
        labelKey: "admin.nav.report.homeworkSla",
        titleKey: "homeworkReport.page.title",
        iconKey: "reports",
        match: "exact",
        roles: ADMIN_ONLY,
      },
